...
namespace BusinessLayer.Domain
{
    public class Robot
    {
        ...
        /// </summary>
        /// <param name="p"></param>
        public void MoveFoward(Plateau p)
        {
            ...
            Constant c = new Constant { positionToAvoidX = newX.ToString(), positionToAvoidY = newY.ToString(), positionToAvoidDirection = m_currentPosition.Direction.ToString() };
            ...
            if (IsInBounds(newX, newY, p.Length, p.Height) && compared == null)                
            {                
